...
Элементу, который мы хотим перекинуть,
добавляем дата атрибут data-da со значениями:

1. Класс элемента, в который хотим перекинуть
2. Позицию внутри этого элемента (last, first, 0, 1, 2 ...)
3. Разрешение экрана, на котором произойдет перенос элемента

Пример:

<div class="content">
    <div class="content__text" data-da="history,last,800">text content</div>
</div>

<div class="history">
    <div class="history__text">text history</div>
</div>

*/


function dinamicAdapt() {
